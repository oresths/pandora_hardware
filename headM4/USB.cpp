...
//            t.start();
            ...
            usb->writeBlock(uGridEYECenterValues, PIXELS_COUNT);
//            t.stop();
//            printf("The time taken was %d useconds\n\r", t.read_us());   //Because the array we send is a multiple of max packet size (64 bytes) a zero-lenth-packet (ZLP) is
